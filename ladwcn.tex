...
\setindexprenote{\kaishu 各条目按照汉语拼音排序。部分条目下有若干子条目，子条目中用波浪线“$\sim$”指代其所属的条目。所有条目（含子条目）后附注英文原文。例如，“数学归纳法（mathematical induction）”条目下的“强$\sim$（strong）”，即表示“强数学归纳法”（strong mathematical induction）。}
\printindex
